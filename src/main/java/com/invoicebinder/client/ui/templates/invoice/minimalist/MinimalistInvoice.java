 ...
 */
package com.invoicebinder.client.ui.templates.invoice.minimalist;
...
public class MinimalistInvoice extends Composite {
    ...
    private static final MinimalistInvoiceUiBinder uiBinder = GWT.create(MinimalistInvoiceUiBinder.class);
    ...
    interface MinimalistInvoiceUiBinder extends UiBinder<Widget, MinimalistInvoice> {
    }
    
    public MinimalistInvoice(Object main, int invoiceId, InvoiceMode mode) {
    ...
    private void setStaticData() {
        ...
        lblDueDateLabel.setText("Due Date: ");
        lblPurchaseOrderNoLabel.setText("Purchase Order No: ");         
        imgLogo.setUrl(GWT.getHostPageBaseURL() + "logo/logo.png");
    }
    private void setStyles() {
        lblTaxInvoice.setStyleName("minimalistinvoice-main-header");
        lblClientHeader.setStyleName("minimalistinvoice-component-header");
        invoicePanel.setStyleName("invoice-inner-container");
        lblCompanyName.setStyleName("minimlistinvoice-text");
        lblCompanyABN.setStyleName("minimlistinvoice-text");
        lblCompanyAddress.setStyleName("minimlistinvoice-text");
        lblCompanySuburb.setStyleName("minimlistinvoice-text");
        lblCompanyStateAndPostCode.setStyleName("minimlistinvoice-text");
        lblCompanyPhone.setStyleName("minimlistinvoice-text");
        lblCompanyEmail.setStyleName("minimlistinvoice-text");
        lblClientName.setStyleName("minimlistinvoice-text");
        lblClientAddress.setStyleName("minimlistinvoice-text");
        lblClientSuburb.setStyleName("minimlistinvoice-text");
        lblClientPhone.setStyleName("minimlistinvoice-text");
        lblClientEmail.setStyleName("minimlistinvoice-text");
        lblInvoiceNumber.setStyleName("minimlistinvoice-text");
        lblInvoiceDate.setStyleName("minimlistinvoice-text");
        lblDueDate.setStyleName("minimlistinvoice-text");
        lblPurchaseOrderNo.setStyleName("minimlistinvoice-text");    
        lblInvoiceNumberLabel.setStyleName("minimlistinvoice-text");
        lblInvoiceDateLabel.setStyleName("minimlistinvoice-text");
        lblDueDateLabel.setStyleName("minimlistinvoice-text");
        lblPurchaseOrderNoLabel.setStyleName("minimlistinvoice-text");    
    ...
    private void setInvoiceItemsData(List<ItemInfo> items, String currencyCode) {
        ...
        itemsTable.getCellFormatter().getElement(0, 0).setClassName("minimalistinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 1).setClassName("minimalistinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 2).setClassName("minimalistinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 3).setClassName("minimalistinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 4).setClassName("minimalistinvoice-item-header");
        //insert items
        idx++;
        ...
        itemsTable.getCellFormatter().setStyleName(idx, 3, "minimalistinvoice-totals");
        itemsTable.getCellFormatter().setStyleName(idx, 4, "minimalistinvoice-totals");
        //insert gst row.
    ...
    private void setCustomAttrData(CustomAttribInfo info) {
        ...
        if ((info.getAttrib1() != null) && (!info.getAttrib1().isEmpty())){
            ...
            customAttribTable.getCellFormatter().getElement(idx, 0).setClassName("minimalistinvoice-component-header");
        }
        idx++;
