 ...
 */
package com.invoicebinder.client.ui.templates.invoice.artistic;
 ...
 * @author msushil
 */
public class ArtisticInvoice extends Composite {
    
    private static final ArtisticInvoiceUiBinder uiBinder = GWT.create(ArtisticInvoiceUiBinder.class);
    @UiField HTMLPanel customAttribPanel;
    @UiField Label lblCompanyHeader;    
    ...
    @UiField Label lblInvoiceNumberLabel;
    @UiField Label lblInvoiceDateLabel;
    @UiField Label lblDueDateLabel;
    @UiField Label lblPurchaseOrderNoLabel;
    ...
    interface ArtisticInvoiceUiBinder extends UiBinder<Widget, ArtisticInvoice> {
    }
    
    public ArtisticInvoice(Object main, int invoiceId, InvoiceMode mode) {
    ...
    private void setStaticData() {
        ...
        lblCompanyHeader.setText("Bill From");
        lblInvoiceNumberLabel.setText("Invoice No: ");
        lblInvoiceDateLabel.setText("Invoice Date: ");
        lblDueDateLabel.setText("Dur Date: ");
        lblPurchaseOrderNoLabel.setText("Bill From");
        imgLogo.setUrl(GWT.getHostPageBaseURL() + "logo/logo.png");
    }
    private void setStyles() {
        lblTaxInvoice.setStyleName("artisticinvoice-main-header");
        lblClientHeader.setStyleName("artisticinvoice-component-header");
        lblCompanyHeader.setStyleName("artisticinvoice-component-header");
        invoicePanel.setStyleName("invoice-inner-container");
        itemsTable.setWidth("100%");
        lblCompanyName.setStyleName("artisticinvoice-text");
        lblCompanyABN.setStyleName("artisticinvoice-text");
        lblCompanyAddress.setStyleName("artisticinvoice-text");
        lblCompanySuburb.setStyleName("artisticinvoice-text");
        lblCompanyStateAndPostCode.setStyleName("artisticinvoice-text");
        lblCompanyPhone.setStyleName("artisticinvoice-text");
        lblCompanyEmail.setStyleName("artisticinvoice-text");
        lblClientName.setStyleName("artisticinvoice-text");
        lblClientAddress.setStyleName("artisticinvoice-text");
        lblClientSuburb.setStyleName("artisticinvoice-text");
        lblClientPhone.setStyleName("artisticinvoice-text");
        lblClientEmail.setStyleName("artisticinvoice-text");
        lblInvoiceNumber.setStyleName("artisticinvoice-text");
        lblInvoiceDate.setStyleName("artisticinvoice-text");
        lblDueDate.setStyleName("artisticinvoice-text");
        lblPurchaseOrderNo.setStyleName("artisticinvoice-text");
        lblInvoiceNumberLabel.setStyleName("artisticinvoice-text");
        lblInvoiceDateLabel.setStyleName("artisticinvoice-text");
        lblDueDateLabel.setStyleName("artisticinvoice-text");
        lblPurchaseOrderNoLabel.setStyleName("artisticinvoice-text");
    }   
    ...
    private void setInvoiceItemsData(List<ItemInfo> items, String currencyCode) {
        ...
        itemsTable.getCellFormatter().getElement(0, 0).setClassName("artisticinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 1).setClassName("artisticinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 2).setClassName("artisticinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 3).setClassName("artisticinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 4).setClassName("artisticinvoice-item-header");
        //insert items
        idx++;
        for (ItemInfo item : items) {
            ...
            itemsTable.getCellFormatter().getElement(idx, 0).setClassName("artisticinvoice-text");
            itemsTable.getCellFormatter().getElement(idx, 1).setClassName("artisticinvoice-text");
            itemsTable.getCellFormatter().getElement(idx, 2).setClassName("artisticinvoice-text");
            itemsTable.getCellFormatter().getElement(idx, 3).setClassName("artisticinvoice-text");
            itemsTable.getCellFormatter().getElement(idx, 4).setClassName("artisticinvoice-text");
        ...
        itemsTable.getCellFormatter().setStyleName(idx, 3, "artisticinvoice-totals");
        itemsTable.getCellFormatter().setStyleName(idx, 4, "artisticinvoice-totals");
        //insert gst row.
    ...
    private void setCustomAttrData(CustomAttribInfo info) {
        ...
        if ((info.getAttrib1() != null) && (!info.getAttrib1().isEmpty())){
            ...
            customAttribTable.getCellFormatter().getElement(idx, 0).setClassName("artisticinvoice-component-header");
        }
        idx++;
