...
*/
package com.invoicebinder.client.ui.templates.invoice.professional;
 ...
 * @author msushil
 */
public class ProfessionalInvoice extends Composite {
    
    private static final ProfessionalInvoiceUiBinder uiBinder = GWT.create(ProfessionalInvoiceUiBinder.class);
    ...
    @UiField InlineLabel lblCompanySuburb;
    @UiField InlineLabel lblCompanyStateAndPostCode;
    ...
    interface ProfessionalInvoiceUiBinder extends UiBinder<Widget, ProfessionalInvoice> {
    }
    
    public ProfessionalInvoice(Object main, int invoiceId, InvoiceMode mode) {
    ...
    private void setStyles() {
        lblTaxInvoice.setStyleName("professionalinvoice-main-header");
        invoicePanel.setStyleName("invoice-inner-container");
        //clear default gwt styles.
        lblClientName.setStyleName("professionalinvoice-billtotext");
        lblClientAddress.setStyleName("professionalinvoice-billtotext");
        lblClientSuburb.setStyleName("professionalinvoice-billtotext");
        lblClientPhone.setStyleName("professionalinvoice-billtotext");
        lblClientEmail.setStyleName("professionalinvoice-billtotext");
        lblInvoiceDate.setStyleName("professionalinvoice-box-value");
        lblDueDate.setStyleName("professionalinvoice-box-value");
        lblAmount.setStyleName("professionalinvoice-box-value");
    ...
    private void setInvoiceItemsData(List<ItemInfo> items, String currencyCode) {
        ...
        itemsTable.getCellFormatter().getElement(0, 0).setClassName("professionalinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 1).setClassName("professionalinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 2).setClassName("professionalinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 3).setClassName("professionalinvoice-item-header");
        itemsTable.getCellFormatter().getElement(0, 4).setClassName("professionalinvoice-item-header");
        //insert items
        idx++;
        ...
        itemsTable.getCellFormatter().setStyleName(idx, 3, "professionalinvoice-totals");
        itemsTable.getCellFormatter().setStyleName(idx, 4, "professionalinvoice-totals");
        //insert gst row.
        ...
        lblAmount.setText(invoiceTotal);
    ...
    private void setBusinessData(BusinessInfo info) {
        ...
        if ((!"".equals(info.getBusinessNumber())) && ("".equals(info.getBusinessNumberLabel()))) {
            info.setBusinessNumberLabel(Constants.DEFAULT_BUSINESS_NUM_LABEL);
        }
        else {
    ...
    private void setCustomAttrData(CustomAttribInfo info) {
        ...
        if ((info.getAttrib1() != null) && (!info.getAttrib1().isEmpty())){
            ...
            customAttribTable.getCellFormatter().getElement(idx, 0).setClassName("invoice-component-header");
        }
        idx++;
